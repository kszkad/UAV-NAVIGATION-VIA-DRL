...
file_paths = []
file_paths.append('method3map13extradis.txt')
file_paths.append('method2map13extradis.txt')
file_paths.append('method1map13extradis.txt')
file_paths.append('method3map12extradis.txt')
file_paths.append('method2map12extradis.txt')
file_paths.append('method1map12extradis.txt')
file_paths.append('method3map11extradis.txt')
file_paths.append('method2map11extradis.txt')
file_paths.append('method1map11extradis.txt')
...
# Y-axis label
ax.set_ylabel('Extra Distance')

# Legend in the top-right corner with a transparent background
ax.legend(loc='upper left', framealpha=0.5)

# Title
# ax.set_title('Extra Distance Across Scenarios and Methods')

# Save the chart as a JPG file
plt.savefig('./figure/extradis.tif', format='tif', dpi=500)
